...
|______\__,_|_|  \__,_| \_/ \___|_|</>'.PHP_EOL.PHP_EOL);
        ...
        if (($process = $this->runCommands($commands, $input, $output))->isSuccessful()) {
            ...
            $output->writeln(PHP_EOL.'<info>Laravel installation done!</info>');

            $output->writeln(PHP_EOL.'<comment>Setting up apache vhosts!</comment>');
